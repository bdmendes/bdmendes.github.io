...
const writingCollection = defineCollection({
  loader: glob({ pattern: "**/[^_]*.{md,mdx}", base: "./content/writing" }),
  schema: () =>
    z.object({
      title: z.string(),
    }),
  ...
  schema: () =>
    z.object({
      white: z
        ...
        .refine(
          (name) =>
            /^[A-ZÀ-ÖØ-Ý][a-zà-öø-ÿA-ZÀ-ÖØ-Ý'-]+ [A-ZÀ-ÖØ-Ý][a-zà-öø-ÿA-ZÀ-ÖØ-Ý'-]+$/.test(
              name,
            ),
          {
            message:
              "White player's name must be two words with capitalized first letters.",
          },
        )
        .optional(),
      black: z
        ...
        .refine(
          ...
          {
            message:
              "Black player's name must be two words with capitalized first letters.",
          },
        )
        .optional(),
